...
if (($_SERVER['REQUEST_METHOD'] ?? '') === 'POST') {
    ...
    } elseif (customerPhoneExists($conn, $form['phone'], $id)) {
    ...
    if (empty($errors)) {
        ...
        $errors[] = "Không thể cập nhật khách hàng: " . mysqli_error($conn);
    }
}
?>
<!doctype html>
...
<head>
    ...
    <title>Sửa khách hàng - Hương Việt</title>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
                    <h1 class="h3 mb-0">Sửa khách hàng</h1>
                ...
                <form method="POST">
                    ...
                    <button type="submit" class="btn btn-primary mt-4">Cập nhật khách hàng</button>
                </form>
            </div>
        </div>
    </main>
