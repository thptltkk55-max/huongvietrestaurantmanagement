...
if (($_SERVER['REQUEST_METHOD'] ?? '') === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt = mysqli_prepare(
            $conn,
            "INSERT INTO foods (category_id, food_name, price, image, description, status)
             VALUES (?, ?, ?, ?, ?, ?)"
        );
        ...
        $errors[] = "Không thể thêm món ăn: " . mysqli_error($conn);
    }
}
...
<head>
    ...
    <title>Thêm món ăn - Hương Việt</title>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
                    <h1 class="h3 mb-0">Thêm món ăn</h1>
                ...
                <form method="POST">
                    ...
                    <button type="submit" class="btn btn-primary mt-4">Lưu món ăn</button>
                </form>
            </div>
        </div>
    </main>
